package com.lenovo.wanba.zk.util;
...
public final class Constant {
	...
	// zk redis配置信息路径
	public static final String PATH_REDIS_CONFIG = "/configuration/redisInstance";
	...
	public static final String PAGE_REDISCONFIG = "config/redisConfig";

	public static final String PAGE_REDISCONFIG_EDIT = "config/redisConfigEdit";
